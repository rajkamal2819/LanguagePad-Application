...
public class TextToVoiceGenerator extends AppCompatActivity {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    switch (toLanguageCode){
                        case 11: tts.setLanguage(Locale.ENGLISH);
                        case 22: tts.setLanguage(new Locale("hin-IND"));
                        case 1: tts.setLanguage(new Locale("ar-DZ"));
                        case 13: tts.setLanguage(new Locale("es-AR"));
                        case 9: tts.setLanguage(Locale.GERMAN);
                        case 44: tts.setLanguage(new Locale("ru-RU"));
                        case 17: tts.setLanguage(Locale.FRENCH);
                    }
                }
            }
        });
    ...
    protected int getLanguageCode(String language){
        int languageCode = 0;
        switch (language){
            case "English": languageCode = 11; break;
            case "Hindi": languageCode = 22; break;
            case "Arabic": languageCode = 1; break;
            case "Spanish": languageCode = 13; break;
            case "German": languageCode =  9; break;
            case "Russian": languageCode = 44; break;
            case "French": languageCode = 17; break;
