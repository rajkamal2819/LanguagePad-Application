...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phrases.add(new Word("What is your name?","tinnә oyaase'nә",-1,R.raw.phrase_what_is_your_name));
        phrases.add(new Word("My name is...", "oyaaset...",-1,R.raw.phrase_my_name_is));
        phrases.add(new Word("How are you feeling?","michәksәs?",-1,R.raw.phrase_how_are_you_feeling));
        phrases.add(new Word("I’m feeling good.","kuchi achit",-1,R.raw.phrase_im_feeling_good));
        phrases.add(new Word("Are you coming?","әәnәs'aa?",-1,R.raw.phrase_are_you_coming));
        phrases.add(new Word("Yes, I’m coming.","hәә’ әәnәm",-1,R.raw.phrase_im_coming));
        phrases.add(new Word("I’m coming.","әәnәm",-1,R.raw.phrase_im_coming));
        phrases.add(new Word("Let’s go.","yoowutis",-1,R.raw.phrase_lets_go));
        phrases.add(new Word("Come here.","әnni'nem",-1,R.raw.phrase_come_here));
