...
public class RussianNumbers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numbers.add(new Word("one","один",R.drawable.number_one,R.raw.russian_one));
        numbers.add(new Word("two","два",R.drawable.number_two,R.raw.russian_two));
        numbers.add(new Word("three","три",R.drawable.number_three,R.raw.russian_three));
        numbers.add(new Word("four","четыре",R.drawable.number_four,R.raw.russian_four));
        numbers.add(new Word("five","Пять",R.drawable.number_five,R.raw.russian_five));
        numbers.add(new Word("six","шесть",R.drawable.number_six,R.raw.russian_six));
        numbers.add(new Word("seven","Семь",R.drawable.number_seven,R.raw.russian_seven));
        numbers.add(new Word("eight","восемь",R.drawable.number_eight,R.raw.russian_eight));
        numbers.add(new Word("nine","девять",R.drawable.number_nine,R.raw.russian_nine));
        numbers.add(new Word("ten","Десять",R.drawable.number_ten,R.raw.russian_ten));
