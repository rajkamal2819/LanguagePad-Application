...
public class GermanNumbers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numbers.add(new Word("one","eins",R.drawable.number_one,R.raw.german_one));
        numbers.add(new Word("two","zwei",R.drawable.number_two,R.raw.german_two));
        numbers.add(new Word("three","drei",R.drawable.number_three,R.raw.german_three));
        numbers.add(new Word("four","vier",R.drawable.number_four,R.raw.german_four));
        numbers.add(new Word("five","fünf",R.drawable.number_five,R.raw.german_five));
        numbers.add(new Word("six","sechs",R.drawable.number_six,R.raw.german_six));
        numbers.add(new Word("seven","Sieben",R.drawable.number_seven,R.raw.german_seven));
        numbers.add(new Word("eight","acht",R.drawable.number_eight,R.raw.german_eight));
        numbers.add(new Word("nine","neun",R.drawable.number_nine,R.raw.german_nine));
        numbers.add(new Word("ten","zehn",R.drawable.number_ten,R.raw.german_ten));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(GermanNumbers.this, w.getAudioResourceId());
                    mMediaPlayer.start();
